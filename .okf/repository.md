...
This repository organizes reusable agent skills into package-scoped bundles under `packages/`.
The main durable structure is the package catalog plus the skill inventory inside each package.

# Package Map

- [Angular Package](/packages/angular.md)
- [Architecture Package](/packages/architecture.md)
...
- [Angular Skills](/skills/angular/index.md)
- [Architecture Skills](/skills/architecture/index.md)
...
- The repository uses `plugin.json` and `installed_version.json` at package level.
- Skills live under `packages/<package>/skills/<skill-name>/`.
- `experimenting/` is for work that is not yet packaged.
