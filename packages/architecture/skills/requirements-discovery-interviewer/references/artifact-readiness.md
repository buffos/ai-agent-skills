...
- the capability goal is clear
- target actors are known
- core capability workflows are named
...
When this skill is being used downstream of `.okf/`, interpret all of the above
as readiness for the owning capability node and its `docs/architecture/<capability-slug>/`
artifact root.
