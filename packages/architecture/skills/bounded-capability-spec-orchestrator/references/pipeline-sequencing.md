...
Assume the sequence applies to one selected bounded capability and its
node-scoped artifacts under `docs/architecture/<capability-slug>/`.
...
- later artifacts expose unclear capability scope, non-goals, or business capabilities
